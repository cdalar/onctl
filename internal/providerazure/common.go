...
// default azure.subscriptionId to it when neither a flag, env var, nor
// .onctl/azure.yaml set one. Returns "" if az isn't installed, isn't logged
// in, or errors out.
...
// default resource group (`az configure --defaults group=<name>`). Most
